...
import { diaries, emotionMains, emotionSubs } from '../../../dummyData'
...
function EmotionAndQuest() {
  ...
  return (
    <main className={S.container}>
      ...
      <section aria-label='퀘스트 수락 여부 선택' className={S.questSection}>
        <h3>추천 퀘스트를 받아보시겠어요?</h3>
        <div className={S.buttons}>
          <button type="button" className={S.reject}>괜찮아요</button>
          <button type="button" className={S.accept}>좋아요</button>
        </div>
      </section>
    </main>
  )
